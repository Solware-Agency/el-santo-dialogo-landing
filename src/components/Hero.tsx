...
export const Hero = () => {
	...
	const heroImage = 'https://lafysstpyiejevhrlmzc.supabase.co/storage/v1/object/public/imagenes/Ideografiko/JGH.webp'
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					...
					<div className="text-center lg:text-left space-y-8">
						...
						<FadeIn delay={ANIMATION_DELAYS.STEP_1}>
							<p
								className={`text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto lg:mx-0 ${BREAKPOINT_CLASSES.PROSE_JUSTIFIED}`}
							>
